...
<input name="query" value="true" type="hidden">
  <table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      <s:textfield label="产品名称" name="productInfo.name" size="50" maxlength="40"/>
    </tr>
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="75%"> <input type="text" name="v_type_name" disabled="disabled" size="30" value="${typename}"/> 
        <input type="button" name="select" value="选择..." onClick="javaScript:winOpen('<s:url value="/control/product/manage!selectUI"/>','列表',600,400)">
      </td>
    </tr>
	<tr bgcolor="f5f5f5"> 
