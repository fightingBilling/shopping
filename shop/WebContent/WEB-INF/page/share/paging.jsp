<%@ page language="java" pageEncoding="UTF-8"%>
	<font 
		color="#FFFFFF"> 总页数:${pageView.totalPage } |
			每页显示:${pageView.maxResult } 条记录 | 总记录数: ${pageView.qr.totalRecord } |
			当前页:${pageView.currentPage } </font> 
	<s:iterator
			begin="pageView.pageIndex.startindex"
